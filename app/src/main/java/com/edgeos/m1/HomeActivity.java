...
public class HomeActivity extends Activity {
    ...
    void render(){
        ...
        root.removeAllViews(); TextView title=new TextView(this); title.setText("EDGEOS"); title.setTextColor(Color.WHITE); title.setTextSize(28); title.setTypeface(null,1); title.setGravity(Gravity.CENTER); root.addView(title,new LinearLayout.LayoutParams(-1,dp(48)));
